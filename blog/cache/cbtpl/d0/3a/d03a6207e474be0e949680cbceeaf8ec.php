<article class="post simple" id="p<?php echo context::global_filters($_ctx->posts->post_id,array (
  ...
  'capitalize' => 0,
  'strip_tags' => 0,
),'EntryID'); ?>" lang="<?php if ($_ctx->posts->post_lang) { echo context::global_filters($_ctx->posts->post_lang,array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'capitalize' => 0,
  'strip_tags' => 0,
),'EntryURL'); ?>"><i class="fas fa-link"></i> <?php echo __('Permalink'); ?></a></span>
